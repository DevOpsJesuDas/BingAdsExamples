...
namespace BingAdsExamplesLibrary.V12
{
    ...
    public class ReportRequests : ExampleBase
    {
        ...
        public async override Task RunAsyncReport(AuthorizationData authorizationData,string FolderPath)
        {
            try
            {
                ...
                {
                    ReportRequest = keywordPerformanceReportRequest,
                    ResultFileDirectory = FolderPath,
                    ResultFileName = authorizationData.AccountId + ".csv",
     ...
     //               {
                ...
                Sort = new[]
                {
                    new KeywordPerformanceReportSort
                        {
                            SortColumn = KeywordPerformanceReportColumn.TimePeriod,
